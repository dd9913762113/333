...
install_xcframework "${PODS_ROOT}/OpenSSL/Sources/Libssl.xcframework" "Libssl" "framework" "ios-arm64" "ios-arm64_x86_64-simulator" "ios-x86_64-maccatalyst"
install_xcframework "${PODS_ROOT}/OpenSSL/Sources/Libcrypto.xcframework" "Libcrypto" "framework" "ios-arm64" "ios-x86_64-maccatalyst" "ios-arm64_x86_64-simulator"
