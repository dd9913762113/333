...
install_xcframework "${PODS_ROOT}/FFmpeg/Sources/Libavcodec.xcframework" "Libavcodec" "framework" "ios-arm64" "ios-arm64_x86_64-simulator" "ios-x86_64-maccatalyst"
install_xcframework "${PODS_ROOT}/FFmpeg/Sources/Libavformat.xcframework" "Libavformat" "framework" "ios-arm64_x86_64-simulator" "ios-arm64" "ios-x86_64-maccatalyst"
install_xcframework "${PODS_ROOT}/FFmpeg/Sources/Libavutil.xcframework" "Libavutil" "framework" "ios-x86_64-maccatalyst" "ios-arm64_x86_64-simulator" "ios-arm64"
install_xcframework "${PODS_ROOT}/FFmpeg/Sources/Libswresample.xcframework" "Libswresample" "framework" "ios-arm64_x86_64-simulator" "ios-x86_64-maccatalyst" "ios-arm64"
install_xcframework "${PODS_ROOT}/FFmpeg/Sources/Libswscale.xcframework" "Libswscale" "framework" "ios-x86_64-maccatalyst" "ios-arm64" "ios-arm64_x86_64-simulator"
