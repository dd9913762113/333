...
//    case media(media: SyncCore.AnyMediaReference, resource: MediaResource)
//
//    case standalone(resource: Postbox.MediaResource)
//
//    case avatar(peer: SyncCore.PeerReference, resource: Postbox.MediaResource)
//
//    case avatarList(peer: SyncCore.PeerReference, resource: Postbox.MediaResource)
//
//    case messageAuthorAvatar(message: SyncCore.MessageReference, resource: Postbox.MediaResource)
//
//    case wallpaper(wallpaper: SyncCore.WallpaperReference?, resource: Postbox.MediaResource)
//
//    case stickerPackThumbnail(stickerPack: SyncCore.StickerPackReference, resource: Postbox.MediaResource)
//
//    case theme(theme: SyncCore.ThemeReference, resource: Postbox.MediaResource)
//
//    public var resource: Postbox.MediaResource { get }
//
...
//    public static func == (lhs: SyncCore.MediaResourceReference, rhs: SyncCore.MediaResourceReference) -> Bool
}
...
//    public init(queue: Queue, postbox: Postbox, resourceReference: MediaResourceReference, tempFilePath: String?, streamable: Bool, video: Bool, preferSoftwareDecoding: Bool, fetchAutomatically: Bool, maximumFetchSize: Int? = nil, stallDuration: Double = 1.0, lowWaterDuration: Double = 2.0, highWaterDuration: Double = 3.0) {
    public init(queue: Queue, resourceReference: MediaResourceReference, tempFilePath: String?, streamable: Bool, video: Bool, preferSoftwareDecoding: Bool, fetchAutomatically: Bool, maximumFetchSize: Int? = nil, stallDuration: Double = 1.0, lowWaterDuration: Double = 2.0, highWaterDuration: Double = 3.0) {
...
//                context.initializeState(postbox: postbox, resourceReference: resourceReference, tempFilePath: tempFilePath, streamable: streamable, video: video, preferSoftwareDecoding: preferSoftwareDecoding, fetchAutomatically: fetchAutomatically, maximumFetchSize: maximumFetchSize)
                context.initializeState( resourceReference: resourceReference, tempFilePath: tempFilePath, streamable: streamable, video: video, preferSoftwareDecoding: preferSoftwareDecoding, fetchAutomatically: fetchAutomatically, maximumFetchSize: maximumFetchSize)
