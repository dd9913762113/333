...
-(UIButton *)speedButton
{
    if (!_speedButton) {
        ...
        [_speedButton setTitle:@"Start" forState:UIControlStateNormal];
//        [_speedButton setTitle:@"开始" forState:UIControlStateHighlighted];
//        _speedButton.backgroundColor = COLOR_WITH_HEX(0x015EAD);
        _speedButton.frame = CGRectMake(20, 600, KSCreenWidth -40, 38);
        [_speedButton setTitleColor:[UIColor grayColor] forState:UIControlStateDisabled];
        _speedButton.layer.cornerRadius = 5.0f;
        [_speedButton setBackgroundColor:XY_TILT_COLOR];
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [self.speedRateLabel setBounds:CGRectMake(0, 0, 300, 30)];
