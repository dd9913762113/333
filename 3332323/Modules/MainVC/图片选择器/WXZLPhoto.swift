...
class WXZLPhoto: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let previewLocalAndNetImageBtn = createBtn("预览本地和网络图片", #selector(previewLocalAndNetImage))
        ...
        let wechatMomentDemoBtn = createBtn("微信 图片选择器", #selector(createWeChatMomentDemo))
...
extension WXZLPhoto: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
