...
class TheNewsViewController: UIViewController {
    ...
    var viewModel: TheNewsViewModel!

    let downloader = TheNewsImageDownloader()

    override func viewDidLoad() {
        super.viewDidLoad()

        viewModel = TheNewsViewModel(controller: self)
        configure()
        viewModel.load()
    }
    ...
    func load(_ style: TheNewsViewModel.Style) {
...
private extension TheNewsViewController {
    ...
    func configureViewCollection() {
        let identifiers = TheNewsViewModel.Style.allCases
            .filter { !$0.isTable }
        ...
        viewCollection.register(LilNewsCell.self, forCellWithReuseIdentifier: LilNewsCell.identifier)
    ...
    func registerAllCell () {
        viewTable.register(ApolloCell.self, forCellReuseIdentifier: ApolloCell.identifier)
        viewTable.register(AppleNewsCell.self, forCellReuseIdentifier: AppleNewsCell.identifier)
        viewTable.register(AppleNewsCellLarge.self, forCellReuseIdentifier: AppleNewsCellLarge.identifier)
        viewTable.register(AppleNewsCellStacked.self, forCellReuseIdentifier: AppleNewsCellStacked.identifier)

        

        viewTable.register(AxiosCell.self, forCellReuseIdentifier: AxiosCell.identifier)
        viewTable.register(BBCCell.self, forCellReuseIdentifier: BBCCell.identifier)
        viewTable.register(CashAppCell.self, forCellReuseIdentifier: CashAppCell.identifier)
        
        viewTable.register(CNNCell.self, forCellReuseIdentifier: CNNCell.identifier)
        viewTable.register(FacebookCell.self, forCellReuseIdentifier: FacebookCell.identifier)
        viewTable.register(FacebookNewsCell.self, forCellReuseIdentifier: FacebookNewsCell.identifier)
        viewTable.register(FastNewsCell.self, forCellReuseIdentifier: FastNewsCell.identifier)
        viewTable.register(FlipboardCell.self, forCellReuseIdentifier: FlipboardCell.identifier)
        
        viewTable.register(InstagramCell.self, forCellReuseIdentifier: InstagramCell.identifier)
//        viewTable.register(LilNewsCell.self, forCellReuseIdentifier: LilNewsCell.identifier)
        viewTable.register(NBCNewsCell.self, forCellReuseIdentifier: NBCNewsCell.identifier)
        viewTable.register(NYTCell.self, forCellReuseIdentifier: NYTCell.identifier)
        viewTable.register(RedditCell.self, forCellReuseIdentifier: RedditCell.identifier)
        
        viewTable.register(RobinhoodCell.self, forCellReuseIdentifier: RobinhoodCell.identifier)
        viewTable.register(RobinhoodCellLarge.self, forCellReuseIdentifier: RobinhoodCellLarge.identifier)

        viewTable.register(TwitterCell.self, forCellReuseIdentifier: TwitterCell.identifier)
        viewTable.register(UIKitCell.self, forCellReuseIdentifier: UIKitCell.identifier)
        viewTable.register(WashingtonPostCell.self, forCellReuseIdentifier: WashingtonPostCell.identifier)
        viewTable.register(WSJCell.self, forCellReuseIdentifier: WSJCell.identifier)

        
    }
    

    func updateCollection(_ style:TheNewsViewModel.Style) {
        switch style {
        case .lilnews:
    ...
    func updateTable(_ style: TheNewsViewModel.Style) {
        switch style {
        case .applenews:
    ...
    func updateVisibility(_ style: TheNewsViewModel.Style) {
        switch style {
        case .lilnews:
