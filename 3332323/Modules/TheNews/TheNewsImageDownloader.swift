...
class TheNewsImageDownloader {

    static let shared = TheNewsImageDownloader()
    ...
    func load(url: URL,
        ...
        let key = TheNewsImageDownloader.key(urlString: urlString, size: size)
...
private extension TheNewsImageDownloader {
...
extension UIImageView {
    ...
    func load(urlString: String?,
              size: CGSize? = nil,
              downloader: TheNewsImageDownloader,
              completion: (() -> Void)? = nil) {
