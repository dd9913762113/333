...
struct TheNewsApi {
    ...
    static func urlForCategory(_ category: String) -> URL? {
        var urlComponents = TheNewsApi.baseUrlComponents

        urlComponents.path = Path.top.rawValue

        let keyQueryItem = TheNewsApi.keyQueryItem
...
//  https://newsapi.org/v2/top-headlines?apiKey=8815d577462a4195a64f6f50af3ada08&country=us&category=general
//  https://newsapi.org/v2/top-headlines?apiKey=8815d577462a4195a64f6f50af3ada08&country=us&category=business
//  https://newsapi.org/v2/top-headlines?apiKey=8815d577462a4195a64f6f50af3ada08&country=us&category=technology
extension URL {

    func get<T: Codable>(completion: @escaping (Swift.Result<T, ApiError>) -> Void) {
