...
private class AppleNewsStackedView: UIView {
    ...
    func load(_ article: Article) {
        ...
        articleImageView.load(urlString: article.urlToImage, size: size, downloader: TheNewsImageDownloader.shared)

        title.text = article.titleDisplay
        ago.text = article.ago
        source.text = article.source?.name

        logo.load(urlString: article.urlToSourceLogo, size: AppleNewsStackedView.logoSize, downloader: TheNewsImageDownloader.shared)
    }
